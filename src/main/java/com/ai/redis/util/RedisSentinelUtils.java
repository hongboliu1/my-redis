...
import com.ai.redis.test.ShardedJedisSentinelPool;
...
public class RedisSentinelUtils {
    ...
    public RedisSentinelUtils(ShardedJedisSentinelPool shardedJedisSentinelPool) {

        this.shardedJedisSentinelPool = shardedJedisSentinelPool;

        Collection<Jedis> allShards = shardedJedisSentinelPool.getResource().getAllShards();
     ...
     *
     * @return public ShardedJedisPipelineUtils buildPipelineUtils() {
    return new ShardedJedisPipelineUtils(this.shardedJedisSentinelPool, this.getResource());
    }
     */
