...
public class RedisUtils {
    ...
    public RedisUtils(String uri, JedisPoolConfig redisConfig) {
        ...
        pool = new ShardedJedisPool(redisConfig, list, Hashing.MURMUR_HASH, Sharded.DEFAULT_KEY_TAG_PATTERN);
...
//	}
     ...
     *
     * @return
     * @see @link link http://redis.cn/commands/sadd.html
     */
     ...
     *
     * @return string 头部元素
     * @see @link link http://redis.cn/commands/lpop.html
     */
     ...
     *
     * @return
     * @see @link link http://redis.cn/commands/rpop.html
     */
